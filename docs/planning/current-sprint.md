...
**Goal:** Vault production readiness, OIDC admin (Phase 5a), security hardening

> Full Phase 5 plan: see [phase-5-sprint.md](./phase-5-sprint.md)
...
All S5 items done — see [phase-4-sprint.md](./phase-4-sprint.md).
