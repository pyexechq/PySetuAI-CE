export interface BlogArticle {
  ...
  title: string;
  excerpt: string;
  category: "Feature" | "Use Case" | "Usability";
  feature: string;
  date: string;
  readTime: string;
  author: string;
...
export const BLOG_ARTICLES: BlogArticle[] = [
  {
    ...
    excerpt:
      "How sensitivity labels, OPA data-movement policy, and conditional ingest keep restricted data out of your vector store.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "Real-time ingress and egress inspection, OPA-backed policy enforcement, and DLP redaction on every LLM request.",
    category: "Feature",
    feature: "AI Gateway",
    date: "2026-08-20",
    readTime: "5 min read",
  ...
  },
  {
    ...
    excerpt:
      "Map OpenAI, Anthropic, and Gemini clients to approved backends with protocol translation and normalized responses.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "Register MCP servers, scope tools to policy bundles, and enforce deny lists on tools/list and tools/call.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "Trace multi-hop MCP call chains, apply per-tool policies, and render an attack-surface graph.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "Discover Copilot M365 and Studio instances, map connectors to risk tiers, and detect drift in real time.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "The Guardian watches agent behavior, scans for injection, flags exfiltration, and auto-remediates.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "Routing rules with client API key binding, provider aliases, weighted failover, and live metrics.",
    category: "Feature",
    feature: "LLM Router",
    date: "2026-08-14",
    readTime: "5 min read",
  ...
  },
  {
    ...
    excerpt:
      "Build policy trees with OPA integration, attach starter rule packs, and bind bundles to ingress keys.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "GenAI evidence bundles, IaC manifest scanning, live framework scoring, and tamper-evident audit logs.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "Real LLM latency, block rates, RAG governance events, dependency health, and OpenTelemetry traces.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "Map policies to graph nodes and understand dependencies between gateway, MCP, RAG, audit, and RBAC.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "OIDC SSO, Vault-backed secrets, Helm charts, and fully air-gapped deployment for regulated teams.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "Provision tenants with branded subdomains, control entitlements, and monitor fleet SLA and usage.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "The Governance Sandbox for dry-runs and a Reports catalog for scheduled compliance exports.",
    category: "Feature",
  ...
  },
  {
    ...
    excerpt:
      "How a financial services team uses PySetu to keep PHI, PCI, and financial data out of models and vector stores.",
    category: "Use Case",
  ...
  },
  {
    ...
    excerpt:
      "How a healthcare organization keeps protected health information out of LLM prompts and tool calls.",
    category: "Use Case",
    feature: "Healthcare",
    date: "2026-08-05",
    readTime: "6 min read",
  ...
  },
  {
    ...
    excerpt:
      "How a SaaS operator provisions tenants, scopes policies per tenant, and monitors fleet health.",
    category: "Use Case",
  ...
  },
  {
    ...
    excerpt:
      "Dry-run prompts, policies, and MCP calls before they reach production — with real-time feedback.",
    category: "Usability",
  ...
  },
  {
    ...
    excerpt:
      "Turn months of audit prep into a one-click export with immutable evidence bundles.",
    category: "Usability",
    feature: "Compliance & Audit",
    date: "2026-08-02",
    readTime: "4 min read",
  ...
  },
  {
    ...
    excerpt:
      "Design policy trees visually with starter rule packs — no OPA expertise required.",
    category: "Usability",
    feature: "Policy Studio",
    date: "2026-08-01",
    readTime: "4 min read",
...
export const BLOG_CATEGORIES = ["Feature", "Use Case", "Usability"] as const;
