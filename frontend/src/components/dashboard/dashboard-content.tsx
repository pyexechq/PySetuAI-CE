          ...
          <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-3 shrink-0">
              <div className="rounded-xl border border-border/80 bg-card/80 p-3.5 shadow-xs backdrop-blur-sm min-w-[130px]">
                ...
                <p className="mt-1.5 text-xl font-bold text-foreground">{metrics.totalRequests}</p>
              ...
              <div className="rounded-xl border border-border/80 bg-card/80 p-3.5 shadow-xs backdrop-blur-sm min-w-[130px]">
                ...
                <p className="mt-1.5 text-xl font-bold text-emerald-600 dark:text-emerald-400">{metrics.successRate}%</p>
              ...
              <div className="rounded-xl border border-border/80 bg-card/80 p-3.5 shadow-xs backdrop-blur-sm min-w-[130px]">
                ...
                <p className="mt-1.5 text-xl font-bold text-rose-600 dark:text-rose-400">{metrics.blockedRequests}</p>
              ...
              <div className="rounded-xl border border-border/80 bg-card/80 p-3.5 shadow-xs backdrop-blur-sm min-w-[130px]">
                ...
                <p className="mt-1.5 text-xl font-bold text-blue-600 dark:text-blue-400">{metrics.complianceScore}%</p>
