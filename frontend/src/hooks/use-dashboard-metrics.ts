...
function mapMetrics(m: (typeof EMPTY_DASHBOARD_OVERVIEW)["metrics"]): DashboardMetrics {
  ...
  return {
    ...
    agenticSecurityEvents: m.agentic_security_events ?? 0,
    agenticSecurityEventsChange: m.agentic_security_events_change_pct ?? 0,
    mcpToolChainEvents: m.mcp_tool_chain_events ?? 0,
    mcpToolChainEventsChange: m.mcp_tool_chain_events_change_pct ?? 0,
